...
[APip2v2.drawio.pdf](https://github.com/user-attachments/files/31546960/APip2v2.drawio.pdf)
...
# Screenshots
### Lambda
This screenshot shows the Lambda function connected to the API Gateway
...
The Lambda code source shows the deployed function's python code in the AWS console 
...
This screenshot displays the runtime metrics and log groups for the Lambda function
...
### CloudWatch
The log group details for the Lambda function confirms successful logging configuration and integration 
...
The log streams generated by CRUD actions confirms real-time logging and event tracking
...
### API Gateway
This screenshot shows the API Gateway routes for the API endpoint
...
This screenshot shows the deployed stage for the project with attached deployment and automatic updates enanbled
...
API Gateway integration setup that shows the successful connection between the API Gateway and the Lambda function
...
This screenshot displays the scan results for the DynamoDB table,which confirms active data retrival and database operation
...
### CloudFront
This screenshot shows active distribution for the project, which confirms successful deployment and global content delivery configuartion
...
Displays the details for the origin configuration linking CloudFront to the API Gateway
...
### WAF
Screenshot confirms successful setup of AWS WAF for threat mitigation and traffic filtering 
...
Displays active managed rules applied to the WAF's web ACL
...
Shows the successful deployment of all resources for the project with all the related key outputs
